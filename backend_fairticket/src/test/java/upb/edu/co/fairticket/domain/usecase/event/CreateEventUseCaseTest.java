...
class CreateEventUseCaseTest {
    ...
    void testExecuteSuccessOrganizerJCorreal() {
        User organizer = User.createOrganizer("Julio Correal", new Email("julio@correal.com"), "hash_falso", "plano_falso");
    ...
    void testExecuteSuccessAdminBetty() {
        User admin = User.createAdmin("Betty la Fea", new Email("betty@ecomoda.com"), "hash_falso", "plano_falso");
    ...
    void testExecuteUnauthorizedBuyer() {
        User buyer = User.createBuyer("Radamel Falcao", new Email("falcao@santamarta.com"), "hash_falso", "plano_falso");
